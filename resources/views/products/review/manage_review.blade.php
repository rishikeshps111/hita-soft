    ...
    <div class="row gj_row ">
        ...
        <div class="col-lg-10 pt-30">
            <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                <div class="col-lg-12">
                     <h3 class="gj_heading"> Manage Product Review  </h3>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_review mob-row-flex">
                                    ...
                                    @foreach($review as $key => $value)
                                        <tr>
                                            ...
                                            <td><input type="checkbox" name="check[]" class="checkBoxClass" value="{{$value->id}}" id="Checkbox{{$i}}" /></td>
                                             <td> @if($value->ReviewProducts)
                                                <a href="{{ route('view_products', ['id' => $value->product_id]) }}">
                                                    <img src="{{ asset($product_path.'/'.$value->ReviewProducts->featured_product_img) }}" width="100">
                                                </a>
                                            @else
                                                <img src="{{ asset('images/no-image.png') }}" width="100">
                                            @endif
                                            </td>
                                            <td>
                                                @if($value->product_id)
                                                    @if(isset($value->ReviewProducts->product_title) && $value->ReviewProducts->product_title)
                                            ...
                                            <td>
                                                @if($value->user_id)
                                                    @if(isset($value->ReviewUser->full_name) )
                                                        {{$value->ReviewUser->full_name}}
                                                    @else
                                                        {{'-----'}}
                                                    @endif
                                                @else
                                            ...
                                            <td>
                                                <span style="display:none;">{{ $value->is_block == 1 ? 'Approved' : 'Reject' }}</span>
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_review_del td-dlt" title="Delete">
