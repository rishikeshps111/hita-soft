...
@media screen and (max-width:567px){
    ...
    .formtop-cs-tb input,.formtop-cs-tb button,.formtop-cs-tb a{
        width:100%;
    }
}
                ...
                <div class="col-md-12">
                    <div class=" gj_manage_product mob-row-flex">
                        <div class="row j-between">
                                ...
                                <div class="col-lg-6">
                                 <form action="{{ route('search_products') }}" method="GET" class="gj_search_pdts_form formtop-cs-tb" enctype="multipart/form-data">
                                    @csrf
                                    <input type="text" name="gj_srh_pdts" id="gj_srh_pdts" class="gj_srh_pdts" placeholder="Search By Products" value="{{request('gj_srh_pdts')}}">
                            ...
                            <thead>
                                <tr>
                                     <tr>
                                        ...
                                        <th>   <div class="th-check-col"> <input type="checkbox" class="pdf-column" value="2" checked> Product <br> Code</div>
                                           </th>
                                        <th>   <div class="th-check-col"><input type="checkbox" class="pdf-column" value="3" checked> Product <br> Name</div>
                                            </th>
                                        <!--<th>   <div class="th-check-col"><input type="checkbox" class="pdf-column" value="4" checked> Product <br> Notes</div>-->
                                        <!--</th>-->
                                        <th><div class="th-check-col">
                                            <input type="checkbox" class="pdf-column" value="5" checked> Category
                                        </div></th>
                                        <th>   <div class="th-check-col"> <input type="checkbox" class="pdf-column" value="6" checked> Stock <br> Quantity</div>
                                           </th>
                                       <!--<th>   <div class="th-check-col"><input type="checkbox" class="pdf-column" value="7" checked><div> Rang <br> <span style="white-space:nowrap;">Price</span></div></div>-->
                                       <!-- </th>-->
                                        <th>   <div class="th-check-col"><input type="checkbox" class="pdf-column" value="8" checked><div> Selling <br> <span style="white-space:nowrap;">Price</span></div></div>
                                            </th>
                                        <th>   <div class="th-check-col"><input type="checkbox" class="pdf-column" value="9" checked> Discount <br>Selling Price</div>
                                            </th>
                                      {{--  <th>   <div class="th-check-col"> <input type="checkbox" class="pdf-column" value="10" checked> Tax Amount</div>
                                           </th>
                                        <th>   <div class="th-check-col"> <input type="checkbox" class="pdf-column" value="11" checked> Domestic <br> Shipping</div>
                                            </th>
                                        <th>   <div class="th-check-col"><input type="checkbox" class="pdf-column" value="12" checked> International <br> Shipping</div>
                                             </th>
                                        <th>   <div class="th-check-col">  <input type="checkbox" class="pdf-column" value="13" checked> Final Selling Price</div>
                                          </th> --}}
                                        <th>   <div class="th-check-col"> <input type="checkbox" class="pdf-column" value="14" checked> Product Image</div>
                                           </th>
                                        <th>   <div class="th-check-col"> <input type="checkbox" class="pdf-column" value="15" checked> Actions</div>
                                           </th>
                                    </tr>
                                </tr>
                            </thead>
                                ...
                                @if($product)
                                    ...
                                    @foreach($product as $key => $value)
                                        <tr>
                                            ...
                                            <td style="max-width:90px !important; min-width:80px !important;"><input type="checkbox" name="check[]" class="checkBoxClass" value="{{$value->id}}" id="Checkbox{{$i}}" /></td>
                                            ...
                                            <td data-sort="{{ $value->original_price }}">Rs. {{$value->original_price?? ''}}</td>
                                            <td data-sort="{{ $value->discounted_price }}">Rs. {{$value->discounted_price?? ''}}</td>
                                            {{--<td data-sort="{{ $value->tax_amount }}">Rs. {{$value->tax_amount ?? ''}}</td>
                                            <td data-sort="{{ $value->shiping_charge }}">Rs. {{$value->shiping_charge ?? ''}}</td>
                                            <td data-sort="{{ $value->inter_shiping_charge }}">Rs. {{$value->inter_shiping_charge ?? '0'}}</td>
                                            <td data-sort="{{ $value->product_cost }}">Rs. {{$value->product_cost ?? ''}}</td> --}}
                                            ...
                                            <td class="gj_p_actions">
                                              <div class="td-action">
                                                    <span>
                                                    <a href="{{ route('edit_product', ['id' => $value->id]) }}" data-tooltip="Edit" class="td-edt">
                                                ...
                                                <span>
                                                    <a href="#" id="{{$value->id}}" class="gj_mge_product_del td-dlt" data-tooltip="Delete" >
                                                        <i class="fa fa-trash fa-2x"></i>
                                                    </a>
                                                </span>
                                                <span>
                                                    <a href="{{ route('view_product', ['id' => $value->id]) }}" id="{{$value->id}}" class="gj_mge_product_vw td-vw" data-tooltip="View">
...
<script> 
$(document).ready(function() { $('#category_id').on('change', function() 
{ 
