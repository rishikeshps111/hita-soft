                                ...
                                @if($sub_stock)
                                    ...
                                    @foreach($sub_stock as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                @if($value->attribute)
                                                    @if(isset($value->Attribute->AttributeName->att_name) && $value->Attribute->AttributeName->att_name && isset($value->Attribute->AttributeValue->att_value) && $value->Attribute->AttributeValue->att_value)
