                                ...
                                <div class="table-responsive gj_vw_p_res">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Offer Type</th>
                                            <td>
                                                @if($deals->offer_type == 1)
                                                    Buy X Get Y
                                                @elseif($deals->offer_type == 2)
                                                    Buy X Get Discount
                                                @else
                                                    {{'---------'}}
                                                @endif
                                        ...
                                        <tr>
                                            <th>Y-Product Count or Discount</th>
                                            <td>
                                                @if($deals->y_pro_cnt)
                                                    {{$deals->y_pro_cnt}}
                                                @elseif($deals->discount)
                                                    {{$deals->discount}}
                                                @else
                                                    {{'-------'}}
                                                @endif
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            @foreach($deals['subs'] as $key => $value)
                                                <tr>
                                                    <td>
                                                        @if($value->product_id)
                                                            @if(isset($value->OfferProducts->product_title) && $value->OfferProducts->product_title)
