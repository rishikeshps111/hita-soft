        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Offer  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Offer  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_offer">
                        <table class="table table-bordered table-striped" id="gj_mge_offer_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                    ...
                                    <th>End Date</th>
                                    <th>X-Product</th>
                                    <th>Y-Product or Discount</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody id="gj_mge_offer_bdy">
                                @if($deals)
                                    @php ($i = 1)
                                    ...
                                    @foreach($deals as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{date('d-m-Y H:i:s', strtotime($value->offer_start))}}</td>
                                            <td>{{date('d-m-Y H:i:s', strtotime($value->offer_end))}}</td>
                                            <td>{{$value->x_pro_cnt}}</td>
                                            <td>
                                                @if($value->y_pro_cnt)
                                                    {{$value->y_pro_cnt}}
                                            ...
                                            <td class="gj_p_actions">
                                                <span>
                                                    <a href="{{ route('edit_offer', ['id' => $value->id]) }}" data-tooltip="Edit">
                                                        <i class="fa fa-edit fa-2x"></i>
                                                    </a>
                                                </span>
                                                <span>
                                                    <a href="{{ route('status_offer', ['id' => $value->id]) }}" data-tooltip="block">
                                                        @if($value->is_block == 1)
                                                ...
                                                <span>
                                                    <a href="#" id="{{$value->id}}" class="gj_mge_offer_del" data-tooltip="Delete">
                                                        <i class="fa fa-trash fa-2x"></i>
                                                    </a>
                                                </span>
                                                <span>
                                                    <a href="{{ route('view_offer', ['id' => $value->id]) }}" id="{{$value->id}}" class="gj_mge_offer_vw" data-tooltip="View">
...
<script>
    ...
    $('.gj_mge_offer_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
