                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="offer_type" name="offer_type" class="form-control gj_offer_type">
                                        ...
                                        <option value="1" @if ($deals->offer_type == 1) {{'selected'}} @endif>Buy X Get Y</option>
                                        <option value="2" @if ($deals->offer_type == 2) {{'selected'}} @endif>Buy X Get Discount</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group gj_y_pro_cnt_div" @if ($deals->offer_type == 1) @else style="display: none;" @endif>
                                ...
                                <div class="form-group gj_discount_div" @if ($deals->offer_type == 2) @else style="display: none;" @endif>
                                    ...
                                    {{ Form::text('discount', ($deals->discount ? $deals->discount : Input::old('discount')), array('class' => 'form-control gj_discount','placeholder' => 'Enter Discount')) }}
                                </div>
...
<!-- Offer Type Script Start -->
    <script type="text/javascript">
        $('body').on('change','.gj_offer_type',function() {
            if($(this).val() == 1) {
                $('.gj_discount_div').slideUp();
                $('.gj_y_pro_cnt_div').slideDown();
            } else if($(this).val() == 2) {
                $('.gj_y_pro_cnt_div').slideUp();
                $('.gj_discount_div').slideDown();
            }
        });
    </script>
<!-- Offer Type Script End -->
@endsection
