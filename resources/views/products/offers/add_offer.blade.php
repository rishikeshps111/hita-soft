                    ...
                    {{ Form::open(array('url' => 'add_offer','class'=>'gj_offer_form','files' => true)) }}
                        <div class="gj_box dark gj_inside_box">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group gj_y_pro_cnt_div" style="display: none;">
                                ...
                                <div class="form-group gj_discount_div" style="display: none;">
                                    ...
                                    {{ Form::text('discount', Input::old('discount'), array('class' => 'form-control gj_discount','placeholder' => 'Enter Discount')) }}
                                </div>
