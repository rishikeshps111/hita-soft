    ...
    <div class="row gj_row">
        ...
        <div class="col-lg-10">
            ...
            <div class="gj_box dark">
                ...
                <div class="col-md-12">
                     <form action="{{ route('update_att_fields') }}" method="POST" class="gj_att_fields_form" enctype="multipart/form-data">
                     @csrf
                        @if($att_fields)
                        <input type="hidden" name="att_fields_id" class="form-control gj_att_fields_id" value="{{ $att_fields->id }}" >
                    ...
                    <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="att_name" class="form-control gj_att_name" placeholder="Attribute Name"  value="{{ old('att_name',$att_fields->att_name) }}" >
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="error">* 
                             ...
                             <textarea name="att_desc" class="form-control gj_att_desc" placeholder="Enter Descriptiion" rows="5">{{ old('att_desc',$att_fields->att_desc) }}</textarea>
                        </div>
                        </div>
