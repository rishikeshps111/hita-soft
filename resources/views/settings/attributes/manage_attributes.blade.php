        ...
        <div class="col-lg-10">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Attributes  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                      <div class="col-lg-12">
                        <h3 class="gj_heading"> Manage Attributes </h3>
                ...
                <div class="col-lg-12">
                    <div class="table-responsive gj_manage_attributes">
                        <table class="table table-bordered table-striped" id="gj_mge_attributes_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                            ...
                            <tbody id="gj_mge_attributes_bdy">
                                @if($attributes)
                                    @php ($i = 1)
                                    <?php 
                                    ...
                                    @foreach($attributes as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value->AttributesFields->att_name}}</td>
                                            <td>{{$value->att_value}}</td>
                                            <td>
                                                @if($value->att_image)
                                                    <a href="{{ asset($file_path.'/'.$value->att_image)}}" target="_blank"><img src="{{ asset($file_path.'/'.$value->att_image)}}" class="img-responsive gj_mge_att_image" alt="{{$value->att_value}}"></a>
                                                @else 
                                                    '---------'
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{ route('edit_attributes', ['id' => $value->id]) }}" data-tooltip="Edit" class="td-edt">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_attributes', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_attributes_del td-dlt" data-tooltip="Delete">
...
<script>
    $(document).ready(function() { 
        $('#gj_mge_attributes_table').dataTable({
            "paginate": false,
            "searching": true,
            "bInfo" : false,
            "sort": true
    ...
    $('.gj_mge_attributes_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
