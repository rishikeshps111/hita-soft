...
@section('title', 'Manage Attributes Fields')
@section('content')
        ...
        <div class="col-lg-10">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Attributes Fields  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                     <div class="col-lg-12">
                        <h3 class="gj_heading"> Manage Attributes Fields </h3>
                ...
                <div class="col-lg-12">
                    <div class="table-responsive gj_manage_att_fields">
                        <table class="table table-bordered table-striped" id="gj_mge_att_fields_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                            ...
                            <tbody id="gj_mge_att_fields_bdy">
                                @if($att_fields)
                                    @php ($i = 1)
                                    
                                    @foreach($att_fields as $key => $value)
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td><input type="checkbox" name="check[]" class="checkBoxClass" value="{{$value->id}}" id="Checkbox{{$i}}" /></td>
                                            <td>{{$value->att_name}}</td>
                                            <td>{{$value->att_desc}}</td>
                                            <td>
                                                <a href="{{ route('edit_att_fields', ['id' => $value->id]) }}" data-tooltip="Edit" class="td-edt">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_att_fields', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_att_fields_del td-dlt" data-tooltip="Delete">
...
<script>
    $(document).ready(function() { 
        $('#gj_mge_att_fields_table').dataTable({
            "paginate": true,
            "searching": true,
            "bInfo" : false,
            "sort": true
    ...
    $('.gj_mge_att_fields_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
