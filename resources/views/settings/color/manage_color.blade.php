    ...
    <div class="row gj_row">
        ...
        <div class="col-lg-10 ">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Colour  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <div class="col-lg-12">
                     <h3 class="gj_heading"> Manage Colour </h3>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_ca mob-row-flex">
                        <table class="table table-bordered table-striped" id="gj_mge_colour_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($colour)
                                    ...
                                    @foreach($colour as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_color', ['id' => $value->id]) }}" data-tooltip="Edit" class="td-edt">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_color', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_colour_del td-dlt" data-tooltip="Delete">
...
<script>
    ...
    $('.gj_mge_colour_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
