        ...
        <div class="col-lg-10 ">
            ...
            <div class="gj_box dark">
                ...
                <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                    <div class="col-lg-12">
                        <h3 class="gj_heading"> Manage Size  </h3>
                                ...
                                @if($size)
                                    ...
                                    @foreach($size as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value->size}}</td>
                                            <td>
                                                <a href="{{ route('edit_size', ['id' => $value->id]) }}" data-tooltip="Edit" class="td-edt">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_size', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_size_del td-dlt" data-tooltip="Delete">
...
<script>
    ...
    $('.gj_mge_size_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
