    ...
    <div class="row gj_row ">
        ...
        <div class="col-lg-10 ">
            ...
            <div class="gj_box dark">
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_cms_page mob-flex-row">
                                ...
                                @if($cms_page)
                                    ...
                                    @foreach($cms_page as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_cms_page', ['id' => $value->id]) }}" data-tooltip="Edit">
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_cms_page_del" data-tooltip="Delete">
