        ...
        <div class="row gj_row ">
            ...
            <div class="col-lg-10 ">
                ...
                <div class="gj_box dark">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('update_banner_image') }}" method="POST" class="gj_geneal_form"
                            ...
                            <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                                ...
                                <div class="col-lg-4 mt__3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="image_title"
                                            value="{{$banner->image_title ? $banner->image_title : old('image_title')}}"
                                            class="form-control gj_image_title" placeholder="Banner Title in English">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-8 mt__3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="button_title"
                                            value="{{$banner->button_title ? $banner->button_title : old('button_title') }}"
                                ...
                                {{-- <div class="col-lg-4 mt__3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="redirect_url"
                                            value="{{$banner->redirect_url ? $banner->redirect_url : old('redirect_url') }}"
                                ...
                                ?>
                                            @if(isset($banner))
                                                @if($banner->banner_image != '')
                                                    <div class="form-group">
                                                        ...
                                                        <div class="gj_ni_div">
                                                            <img src="{{ asset($file_path . '/' . $banner->banner_image)}}"
                                                                class="img-responsive">
                                                        </div>
                                                        <input type="hidden" name="old_banner_image"
                                                            value="{{$banner->banner_image ? $banner->banner_image : ''}}"
                                                            class="form-control ">
                                                    </div>
                                                @endif
                                            @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="gj_not" style="color:red"><em>image size must be 1090 x 450
                                                        pixels</em></p>
