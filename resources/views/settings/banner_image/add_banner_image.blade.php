    ...
    <div class="row gj_row ">
        ...
        <div class="col-lg-10 ">
            ...
            <div class="gj_box dark">
                ...
                <div class="col-md-12">
                    <form action="{{ route('store_banner_image') }}" method="POST" class="gj_geneal_form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <input type="text" name="image_title" class="form-control gj_image_title" placeholder="Banner Title in English">
                              ...
                              <div class="col-lg-4 mt__3">
                                ...
                                <label for="redirect_url">Button Title</label>
                                    ...
                                    <input type="text" name="button_title" value="{{ old('button_title') }}"  class="form-control gj_redirect_url" placeholder="Button Title">
                                </div>
                        ...
                        <label for="redirect_url">Redirect URL</label>
                            ...
                            <input type="text" name="redirect_url" value="{{ old('redirect_url') }}"  class="form-control gj_redirect_url" placeholder="Redirect URL">
