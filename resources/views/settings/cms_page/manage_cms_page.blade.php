    ...
    <div class="row gj_row ">
        ...
        <div class="col-lg-10 ">
            ...
            <div class="gj_box dark">
                ...
                <!--    <h5 class="gj_heading"> Manage CMS Page  </h5>-->
                <!--</header>-->
                 <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                     <div class="col-lg-12">
                         <h3 class="gj_heading">  Manage CMS Page   </h3>
                    ...
                    <button class="btn btn-danger" id="Delete_value" type="button">Delete</button>          
                     ...
                     <div class="col-lg-12">
                    <div class="table-responsive gj_manage_cms_page mob-row-flex">
                        <table class="table table-bordered table-striped container-field-table" id="gj_mge_cms_page_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($cms_page)
                                    ...
                                    @foreach($cms_page as $key => $value)
                                        <tr>
                                            ...
                                            <td><a href="{{route('pages', ['name' => $value->page_name])}}" target="_blank">{{route('pages', ['name' => $value->page_name])}}</a></td>
                                            <td>
                                                <a href="{{ route('edit_cms_page', ['id' => $value->id]) }}" data-tooltip="Edit" class="td-edt">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_cms_page', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_cms_page_del td-dlt" data-tooltip="Delete">
...
<script>
    $(document).ready(function() { 
        $('#gj_mge_cms_page_table').dataTable({
            "paginate": true,
            "searching": true,
            "bInfo" : true,
            "sort": true
    ...
    $('.gj_mge_cms_page_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
