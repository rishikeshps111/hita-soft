...
@section('title', 'Edit Customise Orders')
@section('content')
    ...
    <div class="row gj_row">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <div class="col-md-12">
                    {{ Form::open(array('url' => 'edit_customise_orders','class'=>'gj_orders_form','files' => true)) }}
                        @if($orders)
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control gj_order_date" placeholder="Order Code" name="h_order_date" type="text" value="{{$orders->created_at ? date('d-m-Y', strtotime($orders->created_at)) : Input::old('created_at')}}" id="h_order_date" disabled>

                            <input class="form-control gj_order_date" placeholder="Order Code" name="order_date" type="hidden" value="{{$orders->created_at ? $orders->created_at : Input::old('created_at')}}" id="order_date">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control gj_contact_person" placeholder="Contact Person" name="h_contact_person" type="text" value="{{$orders->name ? $orders->name : Input::old('name')}}" id="h_contact_person" disabled>

                            <input class="form-control gj_contact_person" placeholder="Contact Person" name="contact_person" type="hidden" value="{{$orders->name ? $orders->name : Input::old('name')}}" id="contact_person">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control gj_contact_no" placeholder="Contact Number" name="h_contact_no" type="text" value="{{$orders->phone_number ? $orders->phone_number : Input::old('phone_number')}}" id="h_contact_no" disabled>

                            <input class="form-control gj_contact_no" placeholder="Contact Number" name="contact_no" type="hidden" value="{{$orders->phone_number ? $orders->phone_number : Input::old('phone_number')}}" id="contact_no">
                        </div>
                       ...
                       {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            {{ Form::label('box_quantity', 'Box Quantity') }}
                            <span class="error"> 
                                @if ($errors->has('box_quantity'))
                                    {{ $errors->first('box_quantity') }}
                                @endif
                            </span>

                            <input class="form-control " placeholder="Total Items" name="box_quantity" type="text" value="{{$orders->box_quantity ? $orders->box_quantity : Input::old('box_quantity')}}" id="h_total_items" disabled>

                            <input class="form-control " placeholder="Total Items" name="box_quantity" type="hidden" value="{{$orders->box_quantity ? $orders->box_quantity : Input::old('box_quantity')}}" id="total_items">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::textarea('message', ($orders->message ? $orders->message : Input::old('message')), array('class' => 'form-control gj_remarks','placeholder' => 'Remarks','rows' => '5')) }}
                        </div>
