...
@section('content')
<style>
    .container-field .dataTables_filter input,
    .container-field .dataTables_length select {
        margin-left: 10px;
    }

    .container-field table tr th,
    .container-field table tr td {
    ...
    .filter-row {
        ...
        align-items: center;
        gap: 10px;
        /* spacing between select and button */
    }
                    ...
                    <div class="col-lg-12">
                        <div class="gj_manage_enquiries">
                            {{--<div class="gj_cs_srh_div filter-row " style="position:static;">
                                <form action="{{ route('search_enquiry') }}" method="GET"
                                    class="gj_search_trans_form formtop-cs-tb" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="table-responsive mob-row-flex">
                                <table class="table table-bordered table-striped" id="gj_mge_enquiries_table">
                                    ...
                                    <tbody id="gj_mge_enquiries_bdy">
                                        ...
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td><input type="checkbox" name="check[]" class="checkBoxClass"
                                            ...
                                            <td>{{$value->subject}}</td>
                                            {{--<td>
                                                <a href="{{ route('status_enquiries', ['id' => $value->id]) }}"
                                                    data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="{{ route('view_enquiries', ['id' => $value->id]) }}"
                                                    data-tooltip="block" class="td-vw">
                                                    <i class="gj_view fa fa-eye fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_enquiries_del td-dlt"
                                                    data-tooltip="Delete" class="td-dlt">
