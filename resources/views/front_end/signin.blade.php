...
@section('content')
    ...
    <section class="section-padding login-main-section mt-3">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5">
                    <div class="login-section">
                        ...
                        <form action="{{route('email_signin_check')}}" id="customer_login_email" method="POST"
        ...
        <!-- Reactivation Modal -->
        <div class="modal fade" id="reactivationModal" tabindex="-1" role="dialog" aria-labelledby="reactivationModalLabel"
            aria-hidden="true">
                ...
                <form method="POST" action="{{ route('reactivate.account') }}">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn btn-danger close ms-auto" data-bs-dismiss="modal"
                                aria-label="Close">
