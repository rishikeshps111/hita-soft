                                ...
                                <div class="col-lg-7 col-md-12 col-sm-12 col-12 product-single__detail grid__item ">
                                    <div class="product-single__meta">
                                        ...
                                        <div class="gj_off_avil">
                                            ...
                                            @elseif($offer_products->offer_type == 2)
                                                <h4>Buy {{$offer_products->x_pro_cnt}} Get {{$offer_products->discount}}% Discounts</h4>
                                                <p class="gj_off_note">You have Get This Offer For Buy {{$offer_products->x_pro_cnt}} and Get {{$offer_products->discount}}% Discounts. You Have Selected Main Product to {{$offer_products->x_pro_cnt}} Products</p>
                                            @endif
                                        ...
                                        <div id="shopify-section-collection-template" class="shopify-section">
                                            ...
                                            <div class="caption">
                                                ...
                                                <div class="price">
                                                    ...
                                                    <span class="price-new"><i class="fa fa-inr"></i> <span class="money"> {{$mval->offer_price}}</span> </span> 
                                                </div>
                                            </div>
                                                                                </div>
                                                                            </div>
