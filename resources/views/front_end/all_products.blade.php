...
<div class="cover-head"></div>
 ...
 <section class="">
    ...
    <section class="section-padding pt-4">
        <div class="container">
              <form action="{{route('all_products')}}" class="gj_all_prd_srh " method="GET" enctype="multipart/form-data">
                @csrf
            <div class="row">
                <!-- <div class="col-lg-3">
                   <div class="product-left-container">
                    <div class="product-left">
                        <div class="price-range-cs">
                            <h3>Price</h3>
                            <div class="range-slider">
                                <label for=""></label>

                                <input value="0" min="0" max="120000" step="500" type="range" class="type-rng-inp">
                                <input value="120000" min="0" max="120000" step="500" type="range" class="type-rng-inp pos-inp">
                                <span class="price-top">
                                    <input type="number" value="171" min="0" max="120000" class="rng-input">
                                    <input type="number" value="2200" min="0" max="120000" class="rng-input " style="text-align: end;">
                                </span>
                            </div>
                    ...
                    <div class="product-left-catogory">
                        <h3>Categories</h3>
                        <ul>
                            <li><a href="#!">Earrings <span>12</span></a></li>
                            <li><a href="#!">Necklaces <span>202</span></a></li>
                            <li><a href="#!">Bangles <span>140</span></a></li>
                            <li><a href="#!">Rings <span>72</span></a> </li>
                            <li><a href="#!">Bracelets <span>126</span></a></li>
                        </ul>
                ...
                <div class="col-lg-12">
                    <div class="product-main-container">
                       <div class="row">
                        <div class="col-lg-4">
                            <p class="product-count">{{((isset($all_products) && count($all_products) != 0) ? count($all_products) : 0)}} Products</p>
                        </div>
                        <div class="col-lg-8">
                            <div class="product-filters">
                                <select class="form-select shadow-none gj_product_sort">
                                    <option value="">Price Range</option>
                                    <option value="l_h" {{ request()->get('sort_fitler') == 'l_h' ? 'selected' : '' }}>Low to High</option>
                                    <option value="h_l" {{ request()->get('sort_fitler') == 'h_l' ? 'selected' : '' }}>High to Low</option>
                                </select>
                                <select class="form-select shadow-none gj_sub_cat_filt">
                                    <option value="">Filter By Category</option>
                                   @foreach ($category as $sub)
                                        <option value="{{ $sub->id }}" {{ request()->get('main_cat_filter') == $sub->id ? 'selected' : '' }}>
                                            {{ $sub->main_cat_name }}
                                        </option>
                                    @endforeach
                                </select>
                                 <input type="hidden" name="sort_fitler" class="gj_sort_filter" value="{{ request()->get('sort_fitler', '') }}">
                                 <input type="hidden" name="main_cat_filter" class="gj_sub_cat_filter" value="{{ request()->get('main_cat_filter', '') }}">

                                <!-- <select class="form-select shadow-none">
                                    <option value="">Select Category</option>
                                    <option value="">Earrings</option>
                                    <option value="">Necklaces</option>
                                    <option value="">Bangles</option>
