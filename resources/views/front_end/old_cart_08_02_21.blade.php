                         ...
                         <div class="row">
                            ...
                            <div class="col-sm-6 col-12 text-right small--text-center medium-up--one-half">
                               <div class="cart_border">
                                  ...
                                  <a href="{{ route('home') }}" class="btn btn--secondary cart__update cart__continue--large small--hide" >Continue shopping</a>
                                  <input type="submit" name="update" id="gj_cart_update" class="btn btn--secondary cart__update cart__update--large small--hide" value="Update"> 
                                  <a href="{{ route('checkout') }}"   class="btn btn--secondary cart__update btn btn--small-wide cart__continue--large small--hide" > Checkout </a>
                               </div>
                            </div>
                         </div>
                      </footer>
                         ...
                         <tbody>
                              @foreach ($ses_carts as $key => $value)
                                  <tr class="cart__row border-bottom line1 cart-flex border-top">
                                   ...
                                   <td class="cart__price-wrapper cart-flex-item">
                                      <span class="money">&#8377; <span class="gj_cart_mny">{{$value->price}}</span></span>
                                      <input type="hidden" name="original_price[]" id="price_{{$value->product_id}}" class="gj_c_o_price" value="{{$value->original_price}}">
                                      <input type="hidden" name="price[]" id="price_{{$value->product_id}}" class="gj_c_price" value="{{$value->price}}">
                                   </td>
                                   <td class="cart__price-wrapper cart-flex-item">
                                   ...
                                   <td class="text-left small--hide">
                                      <div>
                                         <span class="money">&#8377; 
                                          <span class="gj_cart_pce">
                                            {{ round(($value->qty * $value->price),2) }}
                                          </span>
                                        </span>
                                      </div>
                                      <input type="hidden" name="total_price[]" id="totprice_{{$value->product_id}}" class="gj_tot_price" value="{{ round($value->qty * ($value->price + (($value->price * $value->tax)/100)),2) }}">
                                   </td>
                                   <td class="text-center wishlist-product">
