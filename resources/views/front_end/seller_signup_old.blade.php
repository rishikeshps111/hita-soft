...
<div class="gj_seller_reg_sec">
    ...
    <section class="ps-section--account gj_seller_reg_frm_sec">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder=" Enter phone number..." name="phone">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder=" Enter Company Name..." name="bussiness_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="  Enter your Answer..." name="answer">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="  Enter Location..." name="address2">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="file" placeholder="  Upload..." accept="image/*" name="profile_img">
                                        </div>
                                    </div>
