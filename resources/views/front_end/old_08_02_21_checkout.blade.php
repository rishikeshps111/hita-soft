                    ...
                    {{ Form::open(array('url' => 'checkout_verif','class'=>'gj_ch_trans','id'=>'gj_ch_trans','files' => true)) }}
                          ...
                          <table class="table wishlist-product">
                            ...
                            <tbody>
                              @foreach ($items as $key => $value)
                                <tr class="row-15484157755503 product-item" id="x15484157755503">
                                  <td>
                                  ...
                                  <td class="text-center">
                                    <div class="price">
                                      <span class="price-new"><span class="money" data-currency-usd="&#8377; {{$value->price}}">&#8377; <span class="gj_ch_d_p">{{$value->price}}</span></span></span>
                                    ...
                                    <input type="hidden" name="product_cost[]" id="dp_{{$value->product_id}}" class="gj_ch_dp" value="{{$value->product_cost}}">
                                  ...
                                  <td class="text-center">
                                      <span class="gj_ch_t">&#8377;<span class="gj_che_tax">{{$value->tax_amount}}</span></span>
                                      <input type="hidden" name="tax[]" id="tax_{{$value->product_id}}" class="gj_ch_tax" value="{{$value->tax}}">
                                      <input type="hidden" name="tax_amount[]" id="taxamount_{{$value->product_id}}" class="gj_ch_tax_amt" value="{{$value->tax_amount}}">
                                  </td>
                                  <!-- <td class="text-center">
                                      <span class="gj_ch_tt">
                                  ...
                                  <td class="text-center">
                                    ...
                                    <input type="hidden" name="total[]" id="total_{{$value->product_id}}" class="gj_ch_total" value="{{$value->total_price}}">
                                  </td>
                                </tr>
                              @endforeach
                              <tr>
                              ...
                              <div class="col-md-12">
                                 <h2 class="page-title">Billing Address</h2>
                                  ...
                                  <div class="row">
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                           ...
                                           <input id="firstname" type="text" placeholder="First Name" name="first_name" class="form-control input-md" value="{{$users->first_name}}">
                                        </div>
                                        <!-- end form-group -->
                                        <div class="form-group">
                                           <input id="email" type="text" placeholder="Email" name="email" class="form-control input-md email" value="{{$users->email}}">
                                        </div>
                                        <!-- end form-group -->
                                     </div>
                                     <!-- end col -->
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                           <input id="surname" type="text" placeholder="Last Name" name="last_name" class="form-control input-md" value="{{$users->last_name}}">
                                        </div>
                                        <!-- end form-group -->
                                        <div class="form-group">
                                           <input id="phone" type="tel" placeholder="Mobile Number *" name="phone" class="form-control input-md required" value="{{$users->phone}}">
                                        </div>
                                        <!-- end form-group -->
                                     </div>
                                  </div>
                                  <div class="row">
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                           <input id="alternate_contact" type="text" placeholder="Alternate Contact Number" name="alternate_contact" class="form-control input-md" value="{{$users->phone2}}">
                                        </div>
                                        <!-- end form-group -->
                                     </div>
                                     <!-- end col -->
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                           <input id="pincode" type="text" placeholder="Pincode" name="pincode" class="form-control input-md required" value="{{$users->pincode}}">
                                        </div>
                                        <!-- end form-group -->
                                     </div>
                                     <!-- end col -->
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        <input id="address1" type="text" placeholder="Address with Flat Number / Building Name:" name="address1" class="form-control input-md" value="{{$users->address1}}">
                                      </div>
                                    </div>

                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        <input id="address2" type="text" placeholder="Full Address" name="address2" class="form-control input-md" value="{{$users->address2}}">
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                     <div class="col-sm-3">
                                        <div class="form-group">
                                           <input id="landmark" type="text" placeholder="Landmark" name="landmark" class="form-control input-md" value="{{$users->landmark}}">
                                        </div>
                                        <!-- end form-group -->
                                     </div>
                                     ...
                                     <div class="col-sm-3">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control state" name="state" id="state" disabled>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                              <div class="form-group">
                                <div class="checkbox">
                                  <label><input type="checkbox" name="is_same" id="is_same" value="1">Is Same as Billing Address</label>
                                </div>
                              </div>
                            </div>
                        ...
                        @if(isset($general) && $general)
                            @if(isset($general->cod) && $general->cod == 1 || isset($general->paypal) && $general->paypal == 1)
                              ...
                              <button class="subscribe btn btn-primary btn-block coniz" type="submit"> Confirm  </button>
                            @else
