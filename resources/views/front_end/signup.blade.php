...
<style>
    ...
    .larger-popup {
        ...
        height: auto !important; /* Prevent automatic height adjustment */
    }
.country-code span {
            ...
            <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="login-section">
                        ...
                        <form action="{{route('email_register')}}" method="POST" class="gj_user_email_register" id="customer_login_email" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <div class="login-field">
                                        <label for="">Full Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control shadow-none" name="full_name" placeholder="Enter Your Full Name" value="{{ old('full_name') }}" >
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="login-field">
                                        ...
                                        <input type="email" class="form-control shadow-none"  name="email" placeholder="Enter Your Email" value="{{ old('email') }}" >
                                         <span class="error text-danger">
                                            @if ($errors->has('email'))
                                                {{ $errors->first('email') }}
                                            @endif
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="login-field">
                                        ...
                                        <div class="country-code">
                                            ...
                                            <input type="mob" class="form-control shadow-none"  name="phone" maxlength="10" placeholder="Enter Your Number" value="{{ old('phone') }}" >
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="login-field">
                                        ...
                                        <input type="text" class="form-control shadow-none" placeholder="Enter Your Password" name="password" >
                                         <span class="error text-danger">
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="subscribe_newsletter" id="subscribe_newsletter" value="1" checked >
