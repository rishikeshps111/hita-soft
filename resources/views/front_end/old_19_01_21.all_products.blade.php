                                    ...
                                    <ul class="toggle-menu list-menu">
                                      @if(isset($category) && (count($category) != 0))
                                        @foreach ($category as $key => $value)
                                            <li>
                                                <a href="#" class="gj_id_fill_cat" data-id ="{{$value->id}}">{{$value->main_cat_name}}<span class="count">( {{$value->cat_count}} )</span></a>
                                            </li>
                                        @endforeach
                                      @else
                                        <li>
                                                            ...
                                                            <div class="gj_ftr_attr">
                                                                @if (isset($attributes) && count($attributes) != 0)
                                                                    @foreach ($attributes as $ky => $vl)
                                                                        @if($vl->id && $vl->id != 0)
                                                                            <a href="#" class="gj_ftr_attr_vls" data-id="{{$vl->id}}">
                                        ...
                                        <div class="products-listing products-grid grid row EndlessClick">
                                            @if(($all_products) && count($all_products) != 0)
                                                @foreach($all_products as $key => $value)
                                                    <div id="product-{{$value->id}}" class="product product-layout grid__item grid__item--collection-template col-xl-3 col-lg-4 col-md-4 col-sm-4 col-xs-6 grid_4" data-price="126.00">
