    ...
    <div class="row gj_row ">
        ...
        <div class="col-lg-10 ">
            ...
            <div class="gj_box dark">
                ...
                @endif
              <div class="head-btn-top">
                    <h3 class="gj_heading"> My Admin Profile  </h3>
                ...
                @if($profile)
                    <p class="gj_pfe_hd" style="text-align:center;">{{$profile->full_name}} Details</p>
                @endif
                    </div>
                    <div class="col-lg-12">
                    <div class="gj_vw_profile">
                        <div class="gj_vw_pfe_res table-responsive adm-product-view">
                            <table class="gj_vw_pfe_tbl table table-striped">
                                @if($profile)
                                    <tr>
                                        <th class="w-50">First Name</th>
                                        <td class="w-50">{{$profile->full_name}}</td>
                                    </tr>
