            ...
            <div class="gj_box dark">
                ...
                @endif
                 <div class=" main-right-container container-field row mx_0 px_5 mb-field">
                     <div class="col-lg-12">
                          <h3 class="gj_heading"> Manage Customers  </h3>
                    ...
                    <form method="GET" id="gj_filter_pdts_form " class="top-select-cs-form">
                        <select name="user_id" class="form-control " id="user_id" >
                            <option value="">Select</option>
                                <option value="1" {{ request('user_id') == '1' ? 'selected' : '' }}>Admin </option>
                                <option value="4" {{ request('user_id') == '4' ? 'selected' : '' }}>Customer </option>
                                <option value="2" {{ request('user_id') == '2' ? 'selected' : '' }}>Admin Staff </option>
                        </select>
                    </form>
                </div>
                     </div>
