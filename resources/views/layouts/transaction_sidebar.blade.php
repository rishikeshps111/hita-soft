<div class="gj_left_menu">
    <div id="gj_left" class="slider-parent active">
        ...
        <ul id="gj_menu" class="">
            ...
            <!-- <li class="panel">-->
            <!--    <a href="{{ route('custom_orders') }}">-->
            <!--        <i class="fa fa-shopping-cart"></i>  Custom Orders-->
            <!--    </a>                   -->
            <!--</li>-->

            <li class="panel">
                <a href="{{ route('cancel_req_orders') }}">
                    <i class="fa fa-shopping-cart"></i> Cancel Order Requests
                </a>                   
            </li>

            <li class="panel">
                <a href="{{ route('cancel_all_orders') }}">
                    <i class="fa fa-first-order"></i> Cancelled Orders
                </a>                   
            </li>
            
            <li class="panel">
                <a href="{{ route('all_deleted_orders') }}">
                    <i class="fa fa-first-order"></i> Admin deleted orders
                </a>                   
            </li>

            <!--<li class="panel">-->
            <!--    <a href="{{ route('return_all_orders') }}">-->
            <!--        <i class="fa fa-cart-arrow-down"></i> Return Orders-->
            <!--    </a>                   -->
            <!--</li>-->
            ...
            <!--        <i class="fa fa-shopping-cart"></i> Replace New Orders-->
            <!--    </a>                   -->
            <!--</li>-->
            ...
            <!--<li class="panel">-->
            <!--    <a href="{{ route('manage_credit_notes') }}">-->
            <!--        <i class="fa fa-money"></i> Credit Notes-->
            <!--    </a>                   -->
            <!--</li>-->
        </ul>
    </div>
