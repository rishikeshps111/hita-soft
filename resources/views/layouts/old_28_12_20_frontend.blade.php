...
<html lang="{{ app()->getLocale() }}"> 
  <head>
    ...
    <meta name="title" content="@if($general) {{$general->meta_title}} @else Online FolkGems Fashion Shopping Website @endif">
    <meta name="description" content="@if($general) {{$general->meta_description}} @else Online FolkGems Fashion Shopping Website @endif">
    <meta name="keywords" content="@if($general) {{$general->meta_keywords}} @else Online FolkGems Fashion Shopping Website @endif">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="group-nav">
                            ...
                            <div class="group-nav__ico group-nav__account no__at">
                                ...
                                <ul class="dropdown-content dropdown-menu sn gj_mob_dd">
                                    <li>
                                      <div class="widget_text pull-right">
                                          <div class="header-login">
                                              <!-- <span class="icon-user wiseer"> <i class="fa fa-user"></i></span> -->
                                    ...
                                    <li>
                                        <a href="{{ route('cart') }}" class="gj_mob_cart">
                                            <i class="fa fa-shopping-cart"></i> 
