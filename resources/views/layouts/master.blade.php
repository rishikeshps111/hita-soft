...
<html lang="{{ app()->getLocale() }}">   
	<head>
        ...
        <meta name="csrf-token" content="{{ csrf_token() }}">
     	...
     	<title>@if($general){{$general->site_name}} @else FolkGems @endif - @yield('title')</title>
        ...
        <link rel="stylesheet" href="{{ asset('css/bk_style.css')}}">
...
<style>
   ...
   <body>
   			...
   			<div class="gj_bg_sec">
	   			<div id="gj_top">
	                	...
	                	<header class="navbar-header">
	                		@if($value)
                                ...
                                @elseif( $value->user_type == 3)
	                   				<a href="{{ route('merchant_dashboard') }}" class="navbar-brand">
               					@else
           					...
           					@endif
	                   			...
	                   			@if($logo)
		                 	  		<img src="{{ asset($logo_path.'/'.$logo->logo_image)}}" height="80px" alt="Logo">
	                   			@else
	                ...
	                <ul class="nav navbar-top-links navbar-right">
	                        @if($value)
	                        	<li>
		                     		<a href="{{ route('home') }}" class="btn btn-default" target="_blank"><i class="fa fa-globe"></i>Website</a>
		                        </li> 
		                      ...
		                      <!--  </li>-->
		                        <li>
		                     		<a href="{{ route('my_profile') }}" class="btn btn-default"><i class="fa fa-user"></i>Profile</a>
		                        </li>
                        ...
                        @if($value->user_type == 1 || $value->user_type == 2 )
							<div class="mainmenu">
				            	...
				            	<ul class="gj_main">
				                	...
				                	<li><a href="{{ route('all_orders') }}">Orders</a> </li>
				                	...
				                	<li><a href="{{route('manage_coupons')}}">Coupons</a></li>
			                	</ul>
		            		</div>
                        @elseif( $value->user_type == 3)
                    		<div class="mainmenu">
    	...
    	<footer>
    		...
    		<div id="gj_footer">
		        <p>© 2018 | @if($general){{$general->site_name}} @else  FolkGems @endif | All Rights Reserved </p>
		    </div>
    	</footer>
