...
class BkpFUIController extends Controller
{
    protected $respose;
    protected $common;
    ...
    public function Home () {
        ...
        $latest_products = Products::Where('is_block',1)->OrderBy('id', 'desc')->take(15)->get();
    ...
    public function CatLists (Request $request) {
        ...
        if(($category) && (count($category) != 0)) {
            ...
            return View::make("front_end.cat_lists")->with(array('category'=>$category));
        } else {
    ...
    public function CareerForm(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            if($career) {
                ...
                $resume_files = Input::file('resume');
    ...
    public function FAQs () {
        $fpage = FAQPage::first();
        $faq = FAQS::Where('is_block', 1)->Where('faq_cat', 1)->get();
        if($fpage) {
    ...
    if ($validator->fails()) {
        return View::make('front_end.signin')->withErrors($validator)->with(array('clogin_type'=>0));
    } else {
    ...
    public function MobileSignInCheck (Request $request) {
        return View::make('front_end.signin')->with(array('clogin_type'=>1));
        $data = Input::all();
    ...
    public function CheckCustomerForgot (Request $request) {
        ...
        if ($validator->fails()) {
            ...
            if ($user) {
                ...
                if($mob_user->save()) {
                    $text = "Please Use this ".$otp." reference code to reset the password,Folkgems.";
                    $text = urlencode($text);
        ...
        if ($validator->fails()) {
            ...
            if($users) {                            
                ...
                if($users->save()) {
                    ...
                    $txt = '
                    <div style="margin: 30px auto 20px; border: 1px solid #ff5c00; width: 602px;">
    <table width="600" align="center" cellpadding="0" cellspacing="0" height="74">
        <tbody>
            <tr bgcolor="#ffffff">
                <td style="padding-left: 20px; padding-top: 10px; padding-bottom: 10px" height="70">
                    <a href="'.route('home').'"><img src="'.$logo.'" border="0"></a>
                </td>
            </tr>
        ...
        <tbody>
            <tr>
                <td style="padding: 10px; font-size: 15px; color: #333333; font-weight: bold; font-family: Segoe UI, Arial, Helvetica, sans-serif">
                    Your registration is completed. Please find your registration details below:
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellpadding="5" cellspacing="0" width="600" align="center">
        <tr>
            <td><b>Your Username (Email)</b></td>
            <td>teamadsdev18@gmail.com</td>
        </tr>
        <tr>
    ...
    <table cellpadding="5" cellspacing="0" width="600" align="center">
        <tr>
            <td>Contact Email</td>
            <td><a href="mailto:parisnta91@gmail.com">parisnta91@gmail.com</a></td>
        </tr>
        <tr>
            <td>Contact Phone</td>
            <td>+919633052041</td>
...
';
                    ...
                    //     </table>
                    // </div>';
                    mail($to,$subject,$txt,$headers) && mail($admin_email,$subject,$txt,$headers);
                    ...
                    // }.
                     ...
                     Session::flash('message', 'Registered Successfully.Logged In');
    ...
    public function MyAccount () {
        ...
        if($value) {
            if($value->user_type == 4) {
                ...
                return View::make("front_end.my_account")->with(array('orders'=>$orders, 'past_orders'=>$past_orders, 'cancel_orders'=>$cancel_orders, 're_orders'=>$re_orders, 'secure'=>$secure, 'general'=>$general,'user_data'=>$user_data));
            } else {
            ...
            if($id != 0) {
                ...
                if ($cancel) {
                    ...
                    if($c_date >= $n_date) {
                        ...
                        if($cancel->save()) {
                            $text = "Your Order Cancel Request against ".$cancel->order_code." has been received, We will  Notify you the status soon, Folkgems.com";
                            $text = urlencode($text);
                        ...
                        <div style="padding: 5px; color: #333; margin: 0px 20px; text-align: center; font-size: 18px;">
                            ...
                            <table align="center" style=" text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 12px;font-weight:bold;color:#333;padding-bottom:12px;"> : '.nl2br($contact->message).'</td>
                                </tr>
                            </table>
            ...
            if($users->user_type == 4) {
                // if($users->mobile_verify == 1) {                
                    // if($users->email_verify == 1) {                
                        ...
                        return View::make("front_end.checkout")->with(array('items'=>$items,'lusr'=>$lusr, 'users'=>$users, 'country'=>$country, 'state'=>$state, 'city'=>$city, 'ships'=>$ships, 'cutoff'=>$cutoff, 'offer_discounts'=>$offer_discounts));
                    /*} else {
    ...
    public function CheckoutVerif( Request $request) {
        ...
        if($user) {
            ...
            if ($validator->fails()) {
                Session::flash('message', 'Fix Shipping Address Validation issue!'); 
                Session::flash('alert-class', 'alert-danger');
                return redirect()->route('checkout')->withErrors($validator);
            } else {
                $sus1 = 0;
                ...
                if($ava_deliv == 1) {
                    ...
                    if($order) {
                        ...
                        if(count($cart) != 0) {
                            ...
                            if(isset($data['cart_dis_tot']) && $data['cart_dis_tot']) {
                                $total_discount = $data['cart_dis_tot'];
                            }
                        ...
                        if($net_amount != 0) {
                            ...
                            $order->offer_discount = $total_discount;
                            ...
                            if($order->save()) {
                                if (isset($cart) && count($cart) != 0) {
                                    foreach ($cart as $key => $value) {
                                        ...
                                        if(isset($value->product_cost)) {
                                            $order_details->unitprice = $value->product_cost;
                                        } else {
...
dd($user->first_name);
                                    ...
                                    // if(1==1){
                                    mail($to,$subject,$txt,$headers) && mail($to2,$subject,$txt,$headers);
                                    if(mail($to,$subject,$txt,$headers) && mail($to2,$subject,$txt,$headers)){
                                        /*if($user->phone) {
