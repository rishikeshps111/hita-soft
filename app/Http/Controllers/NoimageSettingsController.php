        ...
        if($loged) {
            ...
            if($privil) {
                ...
                if ($validator->fails()) {
                    ...
                    if($noimage) {
                        $img_files1 = $request->file('no_image');
                        $old_no_image = $request->get('old_no_image');
                        if(isset($img_files1)) {
                        ...
                        $img_files2 = $request->file('profile_no_img');
                        $old_profile_no_img = $request->get('old_profile_no_img');
                        if(isset($img_files2)) {
                        ...
                        $img_files3 = $request->file('product_no_image');
                        $old_product_no_image = $request->get('old_product_no_image');
                        if(isset($img_files3)) {
                        ...
                        $img_files4 = $request->file('deal_no_image');
                        $old_deal_no_image = $request->get('old_deal_no_image');
                        if(isset($img_files4)) {
                        ...
                        $img_files5 = $request->file('stores_no_image');
                        $old_stores_no_image = $request->get('old_stores_no_image');
                        if(isset($img_files5)) {
                        ...
                        $img_files6 = $request->file('blog_banner_no_image');
                        $old_blog_banner_no_image = $request->get('old_blog_banner_no_image');
                        if(isset($img_files6)) {
                        ...
                        $img_files7 = $request->file('banner_no_image');
                        $old_banner_no_image = $request->get('old_banner_no_image');
                        if(isset($img_files7)) {
                        ...
                        $img_files8 = $request->file('category_banner_no_image');
                        $old_category_banner_no_image = $request->get('old_category_banner_no_image');
                        if(isset($img_files8)) {
                        ...
                        $img_files9 = $request->file('ads_no_image');
                        $old_ads_no_image = $request->get('old_ads_no_image');
                        if(isset($img_files9)) {
                    	...
                    	$img_files10 = $request->file('category_no_image');
                    	$old_category_no_image = $request->get('old_category_no_image');
    ...
    public function destroy(Request $request)
        {
            ...
            if ($type === 'profile' && $noimage->profile_no_img) {
                
                $noimage->profile_no_img = null;
                $noimage->save();
                return response()->json(['success' => true, 'message' => 'Profile No Image deleted']);
            }
        
            if ($type === 'product' && $noimage->product_no_image) {
                
                $noimage->product_no_image = null;
                $noimage->save();
                return response()->json(['success' => true, 'message' => 'Product No Image deleted']);
            }
