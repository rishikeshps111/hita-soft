...
class CreateRejectReturnOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reject_return_order_details', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->double('return_qty', 20, 2)->nullable();
            $table->double('return_amount', 20, 2)->nullable();
            $table->double('return_tax_amount', 20, 2)->nullable();
    ...
    {
        Schema::dropIfExists('reject_return_order_details');
    }
}
